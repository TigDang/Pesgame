  ...
  <div class="wrapper">
    ...
    <div class="main_block container">
      <div class="main_block_body">
        <div class="task_text"><span>Задание:</span> Перед вами представлены карточки. Выберите все, на которых изображены млекопитающие</div>
        <div class="cards">
        ...
        <div v-bind:class="{'down_block': isVisibleResult, 'not_visible': !isVisibleResult}">
          ...
          <div class="button_block">
            <div v-if="!isVisibleAgain">
              <router-link :to="{name: 'text_game_3', params:{name:username, allScore:score}}" class="next_button" >Следующий уровень</router-link>
            </div>
...
export default {
  ...
  methods:{
    ...
    results () {
      ...
      if(this.scoreLevel > parseInt(sessionStorage.getItem('scoreLevel4'))) {
        sessionStorage.setItem('allScore', parseInt(sessionStorage.getItem('allScore')) - parseInt(sessionStorage.getItem('scoreLevel4')))
        sessionStorage.setItem('scoreLevel4', this.scoreLevel)
        sessionStorage.setItem('allScore', parseInt(sessionStorage.getItem('allScore')) + parseInt(sessionStorage.getItem('scoreLevel4')))
      }
      this.score = parseInt(sessionStorage.getItem('allScore'))
    },
